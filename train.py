...
class Args():
    def __init__(self):
        ...
        self.train_data_json = "train_data.json"
        self.validate_data_json = "validate_data.json"
...
def load_json(json_file):
    json_data = open(json_file, "rt", encoding="UTF8")
...
def preprocess():
    ## Preprocess dataset
    train_data = load_json(args.train_data_json)
    #print(len(train_data))

    validate_data = load_json(args.train_data_json)
